        ...
        children: [
          ...
          Expanded(
            child: ListView(
              ...
              children: [
                _buildSlider('pH Level', _simPh, 6.0, 9.5, (val) => setState(() => _simPh = val)),
                ...
                ElevatedButton(
                  ...
                  child: const Text('RESET TO CURRENT DATA', style: TextStyle(color: Colors.black, fontWeight: FontWeight.bold)),
                ),
              ],
            ),
          ),
